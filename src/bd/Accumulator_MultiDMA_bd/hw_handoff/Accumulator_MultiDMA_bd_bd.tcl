...
################################################################
# This is a generated script based on design: Accumulator_MultiDMA_bd
#
...
# source Accumulator_MultiDMA_bd_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# Accumulator_MultiDMA
...
set design_name Accumulator_MultiDMA_bd
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./Projects/Verilog/AXI-MultiDMA-Ultra96V2/src/bd
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Accumulator_MultiDMA_0, and set properties
  set block_name Accumulator_MultiDMA
  set block_cell_name Accumulator_MultiDMA_0
  if { [catch {set Accumulator_MultiDMA_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Accumulator_MultiDMA_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net Accumulator_MultiDMA_0_m_axis [get_bd_intf_pins Accumulator_MultiDMA_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Accumulator_MultiDMA_0/s_axis_0] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins Accumulator_MultiDMA_0/s_axis_1] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins axi_dma_1/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_MM2S [get_bd_intf_pins Accumulator_MultiDMA_0/s_axis_3] [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_MM2S [get_bd_intf_pins axi_dma_2/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXIS_MM2S [get_bd_intf_pins Accumulator_MultiDMA_0/s_axis_2] [get_bd_intf_pins axi_dma_3/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_2/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins axi_gpio_3/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M07_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins axi_gpio_4/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins axi_gpio_5/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins axi_gpio_6/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M11_AXI [get_bd_intf_pins axi_gpio_7/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net Accumulator_MultiDMA_0_accu_finished [get_bd_pins Accumulator_MultiDMA_0/accu_finished] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_accu_length_0_debug [get_bd_pins Accumulator_MultiDMA_0/accu_length_0_debug] [get_bd_pins axi_gpio_4/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_accu_length_1_debug [get_bd_pins Accumulator_MultiDMA_0/accu_length_1_debug] [get_bd_pins axi_gpio_5/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_accu_length_2_debug [get_bd_pins Accumulator_MultiDMA_0/accu_length_2_debug] [get_bd_pins axi_gpio_6/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_accu_length_3_debug [get_bd_pins Accumulator_MultiDMA_0/accu_length_3_debug] [get_bd_pins axi_gpio_7/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_step_debug [get_bd_pins Accumulator_MultiDMA_0/step_debug] [get_bd_pins axi_gpio_3/gpio_io_i]
  connect_bd_net -net Accumulator_MultiDMA_0_sum_debug [get_bd_pins Accumulator_MultiDMA_0/sum_debug] [get_bd_pins axi_gpio_2/gpio_io_i]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins Accumulator_MultiDMA_0/accu_en] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins Accumulator_MultiDMA_0/m_axis_aresetn] [get_bd_pins Accumulator_MultiDMA_0/s_axis_0_aresetn] [get_bd_pins Accumulator_MultiDMA_0/s_axis_1_aresetn] [get_bd_pins Accumulator_MultiDMA_0/s_axis_2_aresetn] [get_bd_pins Accumulator_MultiDMA_0/s_axis_3_aresetn] [get_bd_pins Accumulator_MultiDMA_0/sys_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_gpio_4/s_axi_aresetn] [get_bd_pins axi_gpio_5/s_axi_aresetn] [get_bd_pins axi_gpio_6/s_axi_aresetn] [get_bd_pins axi_gpio_7/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins ps8_0_axi_periph/M11_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins Accumulator_MultiDMA_0/m_axis_aclk] [get_bd_pins Accumulator_MultiDMA_0/s_axis_0_aclk] [get_bd_pins Accumulator_MultiDMA_0/s_axis_1_aclk] [get_bd_pins Accumulator_MultiDMA_0/s_axis_2_aclk] [get_bd_pins Accumulator_MultiDMA_0/s_axis_3_aclk] [get_bd_pins Accumulator_MultiDMA_0/sys_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_mm2s_aclk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_gpio_4/s_axi_aclk] [get_bd_pins axi_gpio_5/s_axi_aclk] [get_bd_pins axi_gpio_6/s_axi_aclk] [get_bd_pins axi_gpio_7/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK] [get_bd_pins ps8_0_axi_periph/M11_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_5/S_AXI/Reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_6/S_AXI/Reg] -force
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_7/S_AXI/Reg] -force

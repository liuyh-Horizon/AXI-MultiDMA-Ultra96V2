...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-MultiDMA/Accumulator_MultiDMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_MultiDMA_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accumulator_MultiDMA_bd_wrapper.tcl

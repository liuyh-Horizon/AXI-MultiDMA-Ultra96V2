...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-MultiDMA/Accumulator_MultiDMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_MultiDMA_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Accumulator_MultiDMA_bd_wrapper.tcl -notrace

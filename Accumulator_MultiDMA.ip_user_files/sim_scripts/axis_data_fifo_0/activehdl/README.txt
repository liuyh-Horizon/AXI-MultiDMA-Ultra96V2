...
#
# Generated by export_simulation on Mon Aug 29 03:44:07 CEST 2022
#
################################################################################
...
'-reset_run' switch to the './axis_data_fifo_0.sh' script.

./axis_data_fifo_0.sh -reset_run
...
./axis_data_fifo_0.sh -noclean_files

For more information on the script, please type './axis_data_fifo_0.sh -help'.
